...
| Project | Description |
| :--- | :---: |
| [aws-airflow-ec2-pipeline](https://github.com/t-smith0193/Data-Engineering/tree/main/projects/aws-airflow-ec2-pipeline) | Create a Dockerized Apache Airflow deployment on AWS EC2, allowing pipelines to run independently of local infrastructure. Also implemented system health monitoring using CloudWatch, SNS, Lambda, and Slack to deliver real-time alerts for CPU utilization and EC2 instance status.This project serves as the orchestration foundation for future pipelines.
