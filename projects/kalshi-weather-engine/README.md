...
The goal is to combine batch modeling (Airflow + DuckDB + S3) with notification (Lambda + Slack) to continuously compare live weather and forecasts against current market pricing and create useful signals as they happen.
<br><br>
